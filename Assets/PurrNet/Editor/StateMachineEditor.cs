...
public class StateMachineEditor : Editor
{
    ...
    private void DrawStateMachineInfo()
    {
        ...
        using(new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
        {
            ...
            EditorGUILayout.LabelField("Current State:", currentState.stateId >= 0 ? 
                _stateMachine.states[currentState.stateId].GetType().Name : "None");
            ...
            if (currentState.stateId >= 0)
            {
                ...
                if (_stateMachine.previousStateId >= 0 && _stateMachine.previousStateId < _stateMachine.states.Count)
    ...
    private void DrawReadOnlyObject(object obj)
    {
        ...
        else
        {
            ...
            {
                foreach (var field in obj.GetType().GetFields(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public))
                {
